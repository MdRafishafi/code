...
class Auth with ChangeNotifier {
  ...
  String _sentTo;
  String _through;
  final String _userDataStorageKey = 'conductorDetails';
  String _userId;
  String _userMail;
  String _userOTPId;
  String _userName;
  ...
  Future<void> isUserInDatabase() async {
    final url = baseUrl + '/conductor/is-user/$_userId';
    try {
  ...
  Future<void> login(String email, String password) async {
    final url = baseUrl + '/conductor/login';
  ...
  Future<void> forgotPassword(String data) async {
    final url = baseUrl + '/conductor/send-otp';
    Map<String, String> body = {
      'user_data': data.trim(),
    };
    var encodedBody = body.keys.map((key) => "$key=${body[key]}").join("&");
  ...
  Future<void> verifyOTP(String otp) async {
    final url = baseUrl + '/conductor/verify-otp';
    Map<String, String> body = {
      'otp_id': _otpId,
      'otp': otp.trim(),
    };
  ...
  Future<void> resendOTP() async {
    final url = baseUrl + '/conductor/resend-otp';
    Map<String, String> body = {
      'otp_id': _otpId,
      'through': _through,
    };
  ...
  Future<void> changePassword(String password) async {
    final url = baseUrl + '/conductor/change-password';
    Map<String, String> body = {
      'user_id': _userOTPId,
      'password': password,
    };
  ...
  Future<void> signUp(String id, String name, String email, String password,
      String userphonenumber) async {
    final url = baseUrl + '/conductor/register';
    Map<String, String> body = {
      "id": id.trim(),
      'email': email.trim(),
      'password': password.trim(),
  ...
  Future<void> getUserDetails() async {
    final url = baseUrl + '/conductor/get-user-details/' + _userId;
  ...
  Future<void> sendUserDetails(String name, String userPhoneNumber,
    ...
    final url = baseUrl + '/conductor/set-user-details/' + _userId;
    Map<String, String> body = {
      'name': name.trim(),
      'phone_number': userPhoneNumber.trim(),
