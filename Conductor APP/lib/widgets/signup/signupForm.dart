...
class _SignupFormState extends State<SignupForm> {
  ...
  var _conductorIDController = TextEditingController();
  final FocusNode _conductorIDFocus = FocusNode();
  @override
              ...
              TextFormField(
                onFieldSubmitted: (term) {
                  FontCustomizer.fieldFocusChange(
                    context: context,
                    currentFocus: _conductorIDFocus,
                ...
                validator: (String value) {
                  if (value.isEmpty || value.length != 6) {
                    return 'Please enter a valid Conductor number';
                  }
                  return null;
                },
